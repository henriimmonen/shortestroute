...
class Ui:
    ...
    def kysy_aloitus_lopetus(self):
        ...
        aloitus_solmu_x = int(input('Anna aloitus-solmu. Rivi: '))
        aloitus_solmu_y = int(input('Anna aloitus-solmu. Sarake: '))
        ...
        lopetus_solmu_x = int(input('Anna lopetus-solmu. Rivi: '))
        lopetus_solmu_y = int(input('Anna lopetus-solmu. Sarake: '))
